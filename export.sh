...
xvfb-run -a openscad -q -D FN=22               -D 'PART="stand"' -o "$OUT/stand_coarse.stl" LabelHolder.scad
xvfb-run -a openscad -q -D FN=20               -D 'PART="axle"'  -o "$OUT/axle_coarse.stl"  LabelHolder.scad
xvfb-run -a openscad -q -D FN=20               -D 'PART="lock"'  -o "$OUT/lock_coarse.stl"  LabelHolder.scad
